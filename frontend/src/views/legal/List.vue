<template>
  <div class="page-container">
    <div class="page-header">
      ...
      <a-tag color="purple">待审核: {{ pendingCount }}</a-tag>
    </div>
...
const columns = [
  ...
  { title: '批准文号', dataIndex: 'approval_number', key: 'approval_number', width: 160 },
  { title: '状态', dataIndex: 'status', key: 'status', width: 120 },
  { title: '版本', dataIndex: 'version', key: 'version', width: 80 },
  { title: '医学审核', dataIndex: 'created_by', key: 'created_by', width: 100 },
...
const loadData = async () => {
  loading.value = true;
  try {
    const res = await legalApi.pending({
